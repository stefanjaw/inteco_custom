{
    ...
    'description': """
    Add the annexes menu in accounting reports, along with all the logic to allow accounts receivable and
    payable reports with cut-off date and aging reports.
    """,
    'category': 'Accounting',
